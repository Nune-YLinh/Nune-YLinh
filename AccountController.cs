...
namespace TTQK7.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                ////lấy roles của nó
                //string[] roles = _role.GetRolesForUser(model.Username);
                //string sRoles = string.Join(",", roles);
                string sRoles = "";
                FormsAuthentication.SetAuthCookie(model.Username, false);
                var authTicket = new FormsAuthenticationTicket(1, model.Username, DateTime.Now, DateTime.Now.AddMinutes(20), false, sRoles);
        ...
        public ActionResult LogOff()
        {
            ...
            return RedirectToAction("Create", "CBaoCao");
        }
